...
export const DetalhesAgendamentoScreen: React.FC<DetalhesAgendamentoScreenProps> = ({
  ...
  const handleDelete = async () => {
    try {
      ...
      Alert.alert('Excluído', 'Agendamento removido com sucesso!', [
        ...
        >
          ...
          <Dialog.Content>
            <Text style={{ color: COLORS.textPrimary }}>
              Tem certeza que deseja remover este agendamento do banco de dados? Esta ação dispara uma requisição HTTP DELETE e não poderá ser desfeita.
            </Text>
          </Dialog.Content>
          <Dialog.Actions>
